...
public class QiuzhiyingpinEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public QiuzhiyingpinEntity() {
		
	}
	
	public QiuzhiyingpinEntity(T t) {
		try {
	 ...
	 * 设置：求职编号
	 */
	public void setQiuzhibianhao(String qiuzhibianhao) {
		this.qiuzhibianhao = qiuzhibianhao;
	}
	/**
	 * 获取：求职编号
	 */
	public String getQiuzhibianhao() {
		return qiuzhibianhao;
	}
	/**
	 * 设置：企业账号
	 */
