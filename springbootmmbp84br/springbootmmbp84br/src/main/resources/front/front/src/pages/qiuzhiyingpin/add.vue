...
<div :style='{"width":"100%","padding":"30px 10% 40px","margin":"0px auto","position":"relative","background":"#fff"}'>
    <el-form
      ...
      label-width="120px"
    >
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="求职编号" prop="qiuzhibianhao">
              <el-input v-model="ruleForm.qiuzhibianhao" placeholder="求职编号" readonly></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="企业账号" prop="qiyezhanghao">
            <el-input  v-model="ruleForm.qiyezhanghao" 
                placeholder="企业账号" clearable :readonly=" false  ||ro.qiyezhanghao"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="企业名称" prop="qiyemingcheng">
            <el-input  v-model="ruleForm.qiyemingcheng" 
                placeholder="企业名称" clearable :readonly=" false  ||ro.qiyemingcheng"></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="岗位分类" prop="gangweifenlei">
            <el-input  v-model="ruleForm.gangweifenlei" 
                placeholder="岗位分类" clearable :readonly=" false  ||ro.gangweifenlei"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="岗位名称" prop="gangweimingcheng">
            <el-input  v-model="ruleForm.gangweimingcheng" 
                placeholder="岗位名称" clearable :readonly=" false  ||ro.gangweimingcheng"></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="应聘日期" prop="yingpinriqi">
              <el-date-picker
...
<script>
  export default {
    ...
    methods: {
      ...
      init(type) {
        ...
        if(type=='cross'){
          ...
          for (var o in obj){
            if(o=='qiuzhibianhao'){
              this.ruleForm.qiuzhibianhao = obj[o];
              this.ro.qiuzhibianhao = true;
              continue;
            }
            if(o=='qiyezhanghao'){
    ...
    // 多级联动参数
      // 多级联动参数
      info() {
        this.$http.get(`qiuzhiyingpin/detail/${this.$route.query.id}`, {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
      ...
      onSubmit() {
			...
			if(this.ruleForm.qiuzhibianhao){
				this.ruleForm.qiuzhibianhao = String(this.ruleForm.qiuzhibianhao)
			}
			//更新跨表属性
			var crossuserid;
			var crossrefid;
			...
			this.$refs["ruleForm"].validate(valid => {
				if(valid) {
					...
					if(crossrefid && crossuserid) {
						...
						this.$http.get('qiuzhiyingpin/list', {
							params: params
						}).then(res => {
							if(res.data.data.total>=crossoptnum) {
								...
								this.$http.post(`qiuzhiyingpin/${this.ruleForm.id?'update':this.centerType?'save':'add'}`, this.ruleForm).then(res => {
									if (res.data.code == 0) {
										this.$message({
											message: '操作成功',
											type: 'success',
