	...
	<div class="main-content" :style='{"minHeight":"100vh","padding":"20px 20px 20px","overflow":"hidden","color":"#93a2a9","background":"#e9ecf3","fontSize":"14px","position":"relative"}'>
		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"border":"0px solid #ddd","padding":"20px 20px 0","margin":"0px 0 0","overflow":"hidden","borderRadius":"0px","flexWrap":"wrap","background":"#fff","display":"flex","width":"auto","fontSize":"inherit","justifyContent":"space-between"}' :inline="true" :model="searchForm">
				<el-row :style='{"padding":"0px","margin":"0 0 10px","borderRadius":"0px","textAlign":"center","flexWrap":"wrap","background":"#fff","flexDirection":"row","display":"flex","width":"auto","fontSize":"inherit","order":"2"}' v-if="!forumChild">
				...
				<el-row :style='{"padding":"0px","margin":"0 0 10px","borderRadius":"0px","textAlign":"center","flexWrap":"wrap","background":"#fff","flexDirection":"row","display":"flex","width":"auto","fontSize":"inherit","order":"2"}' v-if="forumChild">
					<el-button :style='{"cursor":"pointer","padding":"0 10px","borderColor":"#1576c2","margin":"0 0px","color":"#fff","minWidth":"50px","transition":"all 0.3s","borderRadius":"2px","background":"#5eb95e","borderWidth":"0 0 0px","width":"auto","fontSize":"16px","lineHeight":"34px","borderStyle":"solid","height":"34px"}' type="success" @click="search()">返回</el-button>
				</el-row>
