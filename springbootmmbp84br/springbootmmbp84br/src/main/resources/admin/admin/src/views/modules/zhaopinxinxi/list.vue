<template>
	<div class="main-content" :style='{"minHeight":"100vh","padding":"20px 20px 20px","overflow":"hidden","color":"#93a2a9","background":"#e9ecf3","fontSize":"14px","position":"relative"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button class="btn8" v-if="isAuth('zhaopinxinxi','求职应聘')" @click="qiuzhiyingpinCrossAddOrUpdateHandler(scope.row,'cross','是','[1]','己提交')" type="success">
		...
		<qiuzhiyingpin-cross-add-or-update v-if="qiuzhiyingpinCrossAddOrUpdateFlag" :parent="this" ref="qiuzhiyingpinCrossaddOrUpdate"></qiuzhiyingpin-cross-add-or-update>
...
import qiuzhiyingpinCrossAddOrUpdate from "../qiuzhiyingpin/add-or-update";
	export default {
		data() {
			return {
				searchForm: {
				...
				qiuzhiyingpinCrossAddOrUpdateFlag: false,
		...
		methods: {
			...
			qiuzhiyingpinCrossAddOrUpdateHandler(row,type,crossOptAudit,statusColumnName,tips,statusColumnValue){
				...
				this.qiuzhiyingpinCrossAddOrUpdateFlag = true;
				...
				if(statusColumnName!=''&&!statusColumnName.startsWith("[")) {
					...
					for (var o in obj){
						if(o==statusColumnName && obj[o]==statusColumnValue){
							...
							this.showFlag = true;
							this.qiuzhiyingpinCrossAddOrUpdateFlag = false;
							return;
						}
					}
				}
				this.$nextTick(() => {
					this.$refs.qiuzhiyingpinCrossaddOrUpdate.init(row.id,type);
				});
			},
