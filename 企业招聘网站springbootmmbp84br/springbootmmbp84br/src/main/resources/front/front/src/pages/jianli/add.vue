    ...
    >
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="性别" prop="xingbie">
            <el-input  v-model="ruleForm.xingbie" 
                placeholder="性别" clearable :readonly=" false  ||ro.xingbie"></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="专业" prop="zhuanye">
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="学历" prop="xueli">
            <el-input  v-model="ruleForm.xueli" 
                placeholder="学历" clearable :readonly=" false  ||ro.xueli"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="学校" prop="xuexiao">
            <el-input  v-model="ruleForm.xuexiao" 
                placeholder="学校" clearable :readonly=" false  ||ro.xuexiao"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="所获奖项" prop="suohuojiangxiang">
            <el-input  v-model="ruleForm.suohuojiangxiang" 
                placeholder="所获奖项" clearable :readonly=" false  ||ro.suohuojiangxiang"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="所获技能" prop="suohuojineng">
            <el-input  v-model="ruleForm.suohuojineng" 
                placeholder="所获技能" clearable :readonly=" false  ||ro.suohuojineng"></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="在校经历" prop="zaixiaojingli">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="在校经历"
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="自我评价" prop="ziwopingjia">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="自我评价"
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="社会实践" prop="shehuishijian">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="社会实践"
...
<script>
  export default {
    ...
    // 多级联动参数
      // 多级联动参数
      info() {
        this.$http.get(`jianli/detail/${this.$route.query.id}`, {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
					...
					if(crossrefid && crossuserid) {
						...
						this.$http.get('jianli/list', {
							...
							if(res.data.data.total>=crossoptnum) {
								...
								this.$http.post(`jianli/${this.ruleForm.id?'update':this.centerType?'save':'add'}`, this.ruleForm).then(res => {
									if (res.data.code == 0) {
										this.$message({
											message: '操作成功',
											type: 'success',
