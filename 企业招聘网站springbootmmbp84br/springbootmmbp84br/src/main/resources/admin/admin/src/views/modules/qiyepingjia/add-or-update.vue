	...
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px","fontSize":"14px","color":"#666","background":"#e9ecf3"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"auto","fontSize":"inherit"}' class="select" v-if="type!='info'" label="用户账号" prop="yonghuzhanghao">
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"auto","fontSize":"inherit"}' class="input" v-else-if="ruleForm.yonghuzhanghao" label="用户账号" prop="yonghuzhanghao">
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"auto","fontSize":"inherit"}' class="select" v-if="type!='info'"  label="评价等级" prop="pingjiadengji">
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"auto","fontSize":"inherit"}' v-else class="input" label="评价等级" prop="pingjiadengji">
					<el-input v-model="ruleForm.pingjiadengji"
						placeholder="评价等级" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"auto","fontSize":"inherit"}' class="textarea" v-if="type!='info'" label="评价内容" prop="pingjianeirong">
					<el-input
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"auto","fontSize":"inherit"}' v-else-if="ruleForm.pingjianeirong" label="评价内容" prop="pingjianeirong">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"inherit","fontWeight":"500","display":"inline-block"}'>{{ruleForm.pingjianeirong}}</span>
				</el-form-item>
...
export default {
	...
	methods: {
		...
		init(id,type) {
            ...
            this.pingjiadengjiOptions = "优,良,中,差".split(',')
